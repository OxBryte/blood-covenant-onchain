...
export default function ScreenLayout({ subtitle, children, maxWidth = "max-w-6xl" }) {
  ...
  return (
    <div className={`min-h-screen mx-auto w-full ${backgroundClass} transition-colors duration-500`}>
      ...
      <main className="w-full mx-auto">
        <div className={`mx-auto w-full ${maxWidth} space-y-10 transition-all duration-500`}>
