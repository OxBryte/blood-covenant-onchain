export default function VampireProfile({ vampire }) {
  if (!vampire)
    return (
      <div className="text-center py-12 text-xl text-[#b0b0b0]">Loading...</div>
    );
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 shadow-xl">
        <h3 className="text-2xl font-extrabold mb-6 bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">
          Stats
        </h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={stat.name}
              className="flex flex-col items-center justify-between px-5 py-4 bg-gradient-to-br from-gray-900/80 to-black/80 rounded-xl border border-gray-700/30 hover:border-red-700/50 transition-all duration-300 hover:scale-105"
            >
      ...
      <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 shadow-xl">
        ...
        <p className="text-gray-400 mt-6 text-center font-medium">
          ...
          <span className="text-green-400 font-bold">30%</span> of their entry
          fee!
        </p>
      </div>
      ...
      {/* Earnings Breakdown */}
      <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50 shadow-xl">
        <h3 className="text-2xl font-extrabold mb-6 bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">
          Earnings Breakdown
        </h3>
        <div className="flex flex-col gap-3">
          {[
            ...
            <div
              key={earning.label}
              className="flex justify-between items-center px-6 py-4 bg-gradient-to-br from-gray-900/80 to-black/80 rounded-xl border border-gray-700/30 hover:border-gray-600/50 transition-all duration-300 hover:scale-[1.02]"
            >
              <span className="font-semibold text-gray-300">
                {earning.label}
              </span>
              <span
                className={`text-xl font-extrabold bg-gradient-to-r ${earning.color} bg-clip-text text-transparent`}
              >
